...
export const firefightingContent: ProductContent = {
  ...
  metaTitle: "Насосные установки ANHEL® HVS-NU для систем пожаротушения",
  metaDescription:
    "Насосные установки ANHEL® HVS-NU для систем пожаротушения. Обеспечивают необходимое давление и объём воды как в режиме ожидания, так и при тушении возгорания. От 2 до 6 насосов, релейное/частотное регулирование, срок службы не менее 10 лет.",
  ...
  hero: {
    ...
    title: "Насосные установки ANHEL® HVS-NU для систем пожаротушения",
    subtitle:
