...
export const content: ProductContent = {
  ...
  hero: {
    ...
    secondaryCta: { label: "Teknik veri formu", href: "/docs/firefighting/oprosnyi-list-tr.pdf", variant: "ghost" },
  },
  ...
  documents: {
    ...
    items: [
      { id: "oprosnik", title: "Pompa istasyonu teknik veri formu", size: "42 KB", href: "/docs/firefighting/oprosnyi-list-tr.pdf" },
