...
export const quickQuote: QuickQuoteContent = {
  ...
  fieldCompanyPlaceholder: "Design firm or freelancer",
  fieldDeveloper: "Developer",
  fieldDeveloperPlaceholder: "Owner / building developer",
  fieldCity: "City",
  fieldCityPlaceholder: "Saint Petersburg",
  fieldObject: "Facility (address)",
  fieldObjectPlaceholder: "Project name, building, street",
  fieldCadastral: "Cadastral № (if available)",
  fieldCadastralPlaceholder: "47:07:0000000:00000",
  fieldCadastralHint: "Optional. If provided, appears on the quote cover page.",
  consentLabel:
