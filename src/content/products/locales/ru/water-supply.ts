...
export const content: ProductContent = {
  ...
  metaTitle: "Насосные станции ANHEL для систем водоснабжения",
  metaDescription:
    "Насосные станции ANHEL для повышения и поддержания постоянного давления в системах ХВС, ГВС и циркуляции. От 2 до 6 насосов, частотное регулирование, мощность от 0,37 до 90 кВт, срок службы не менее 10 лет.",
  ...
  hero: {
    ...
    title: "Насосные станции ANHEL для систем водоснабжения",
    subtitle:
  ...
  description: {
    ...
    paragraphs: [
      "Насосные установки ANHEL для систем хозяйственно-питьевого, технического и горячего водоснабжения. Поддерживают постоянное давление в сети, защищают трубопровод от гидроударов и экономят электроэнергию за счёт частотного регулирования и плавного пуска.",
      "Сборка на базе многоступенчатых вертикальных, консольных или моноблочных горизонтальных насосов. Конфигурация подбирается под гидравлические параметры объекта; автоматика — релейная, частотная или КЧП — выбирается под задачу системы.",
    ],
  },
  ...
  advantages: {
    ...
    items: [
      ...
      },
      {
        ...
        body: "Полный средний срок службы — не менее 10 лет при штатной эксплуатации. Декларации соответствия и паспорта — в поставке.",
      },
    ],
  },
  ...
  gallery: {
    ...
    photos: [
      {
        id: "water-supply-01",
        src: "/assets/production/water-supply/water-supply-01.jpg",
        alt: "ANHEL — производство насосной станции водоснабжения, фото 1",
        aspect: "4/5",
      },
      {
        id: "water-supply-02",
        src: "/assets/production/water-supply/water-supply-02.jpg",
        alt: "ANHEL — производство насосной станции водоснабжения, фото 2",
        aspect: "4/5",
      },
      {
        id: "water-supply-03",
        src: "/assets/production/water-supply/water-supply-03.jpg",
        alt: "ANHEL — производство насосной станции водоснабжения, фото 3",
        aspect: "4/5",
      },
      {
        id: "water-supply-04",
        src: "/assets/production/water-supply/water-supply-04.jpg",
        alt: "ANHEL — производство насосной станции водоснабжения, фото 4",
        aspect: "4/5",
      },
      {
        id: "water-supply-05",
        src: "/assets/production/water-supply/water-supply-05.jpg",
        alt: "ANHEL — производство насосной станции водоснабжения, фото 5",
        aspect: "4/5",
      },
      {
        id: "water-supply-06",
        src: "/assets/production/water-supply/water-supply-06.jpg",
        alt: "ANHEL — производство насосной станции водоснабжения, фото 6",
        aspect: "4/5",
      },
      {
        id: "water-supply-07",
        src: "/assets/production/water-supply/water-supply-07.jpg",
        alt: "ANHEL — производство насосной станции водоснабжения, фото 7",
        aspect: "4/5",
      },
      {
        id: "water-supply-08",
        src: "/assets/production/water-supply/water-supply-08.jpg",
        alt: "ANHEL — производство насосной станции водоснабжения, фото 8",
        aspect: "4/5",
      },
      {
        id: "water-supply-09",
        src: "/assets/production/water-supply/water-supply-09.jpg",
        alt: "ANHEL — производство насосной станции водоснабжения, фото 9",
        aspect: "4/5",
      },
      {
        id: "water-supply-10",
        src: "/assets/production/water-supply/water-supply-10.jpg",
        alt: "ANHEL — производство насосной станции водоснабжения, фото 10",
        aspect: "4/5",
      },
      {
        id: "water-supply-11",
        src: "/assets/production/water-supply/water-supply-11.jpg",
        alt: "ANHEL — производство насосной станции водоснабжения, фото 11",
        aspect: "4/5",
      },
      {
        id: "water-supply-12",
        src: "/assets/production/water-supply/water-supply-12.jpg",
        alt: "ANHEL — производство насосной станции водоснабжения, фото 12",
        aspect: "4/5",
      },
      {
        id: "water-supply-13",
        src: "/assets/production/water-supply/water-supply-13.jpg",
        alt: "ANHEL — производство насосной станции водоснабжения, фото 13",
        aspect: "4/5",
      },
      {
        id: "water-supply-14",
        src: "/assets/production/water-supply/water-supply-14.jpg",
        alt: "ANHEL — производство насосной станции водоснабжения, фото 14",
        aspect: "4/5",
      },
    ],
  },
    ...
    items: [
      {
        ...
        title: "ЖК «Пример №1»",
        location: "Москва",
        equipment: "Насосная станция ANHEL для ХВС",
      ...
      },
      {
        ...
        equipment: "Станция повышения давления ANHEL",
        photo: { alt: "Жилой комплекс, общий вид" },
      },
      {
        id: "bc-placeholder",
        ...
        location: "Москва",
        equipment: "Станция ХВС + ГВС ANHEL",
