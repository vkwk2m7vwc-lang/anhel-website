...
export const content: ProductContent = {
  ...
  // Section 7 «Преимущества». Шесть пунктов — самые конкретные. Удалены
  // own-modules (общая формулировка), compact (общее) и references
  // (без конкретики); инженерные USP остались — серия, ТЗ, QC, режимы,
  // ресурс, документация.
  advantages: {
    tag: "06 · ПРЕИМУЩЕСТВА",
    title: "Почему ANHEL®",
  ...
  gallery: {
    ...
    photos: [
      {
        id: "firefighting-01",
        src: "/assets/production/firefighting/firefighting-01.jpg",
        alt: "ANHEL — производство станции пожаротушения, фото 1",
        aspect: "4/5",
      },
      {
        id: "firefighting-02",
        src: "/assets/production/firefighting/firefighting-02.jpg",
        alt: "ANHEL — производство станции пожаротушения, фото 2",
        aspect: "4/5",
      },
      {
        id: "firefighting-03",
        src: "/assets/production/firefighting/firefighting-03.jpg",
        alt: "ANHEL — производство станции пожаротушения, фото 3",
        aspect: "4/5",
      },
      {
        id: "firefighting-04",
        src: "/assets/production/firefighting/firefighting-04.jpg",
        alt: "ANHEL — производство станции пожаротушения, фото 4",
        aspect: "4/5",
      },
      {
        id: "firefighting-05",
        src: "/assets/production/firefighting/firefighting-05.jpg",
        alt: "ANHEL — производство станции пожаротушения, фото 5",
        aspect: "4/5",
      },
      {
        id: "firefighting-06",
        src: "/assets/production/firefighting/firefighting-06.jpg",
        alt: "ANHEL — производство станции пожаротушения, фото 6",
        aspect: "4/5",
      },
      {
        id: "firefighting-07",
        src: "/assets/production/firefighting/firefighting-07.jpg",
        alt: "ANHEL — производство станции пожаротушения, фото 7",
        aspect: "4/5",
      },
      {
        id: "firefighting-08",
        src: "/assets/production/firefighting/firefighting-08.jpg",
        alt: "ANHEL — производство станции пожаротушения, фото 8",
        aspect: "4/5",
      },
      {
        id: "firefighting-09",
        src: "/assets/production/firefighting/firefighting-09.jpg",
        alt: "ANHEL — производство станции пожаротушения, фото 9",
        aspect: "4/5",
      },
      {
        id: "firefighting-10",
        src: "/assets/production/firefighting/firefighting-10.jpg",
        alt: "ANHEL — производство станции пожаротушения, фото 10",
        aspect: "4/5",
      },
      {
        id: "firefighting-11",
        src: "/assets/production/firefighting/firefighting-11.jpg",
        alt: "ANHEL — производство станции пожаротушения, фото 11",
        aspect: "4/5",
      },
    ],
  },
