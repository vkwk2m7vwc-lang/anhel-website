...
export const waterTreatmentContent: ProductContent = {
  ...
  metaTitle: "Установки водоподготовки",
  metaDescription:
    "Установки водоподготовки ANHEL® — фильтрация, умягчение, обезжелезивание, обратный осмос. Для промышленных, пищевых и жилых объектов. Срок службы от 10 лет.",
  ...
  hero: {
    ...
    title: "Установки водоподготовки",
    subtitle:
      "Фильтрация, умягчение, обезжелезивание, обратный осмос. Проектирование под качество входной воды и технологические требования объекта.",
    image: {
