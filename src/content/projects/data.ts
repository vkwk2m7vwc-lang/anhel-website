...
export const PROJECTS: ProjectItem[] = [
  ...
  },
  {
    ...
    equipment: [
      ...
      "Мультизональные системы кондиционирования VRF HAIER",
    ],
  ...
  },
  {
    ...
    equipment: [
      ...
      "Балансировочная арматура РИДАН",
      "Система тёплого пола ANHEL",
      "Нержавеющая труба на press-фитингах KAN-therm",
    ],
