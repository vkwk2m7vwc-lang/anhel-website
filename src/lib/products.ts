...
export const CONTROL_SYSTEMS_PRODUCTS: readonly ProductSummary[] = [
  ...
  },
  {
    ...
    accent: "treatment",
    image: "/assets/products/control-systems/electric-actuators/hero.webp",
    accentHex: "#8A94A0",
  },
  {
    ...
    accent: "fire",
    image: "/assets/products/control-systems/fire-suppression/hero.webp",
    accentHex: "#D72638",
  },
  {
    slug: "smoke-control",
    ...
    accent: "fire",
    image: "/assets/products/control-systems/smoke-control/hero.webp",
    accentHex: "#D72638",
  },
  {
    slug: "sewage-pumping",
    ...
    accent: "water",
    image: "/assets/products/control-systems/sewage-pumping/hero.webp",
    accentHex: "#1E6FD9",
  },
] as const;
