      ...
      >
        <div className="mx-auto w-full max-w-[1440px] px-6 pb-12 pt-32 md:px-12 md:pb-20 md:pt-40">
          ...
          <p className="mt-6 max-w-[640px] text-[var(--color-secondary)]/70 md:text-[18px] md:leading-[1.55]">
            ...
            водоподготовки ANHEL®. Жилые комплексы крупных девелоперов
            Москвы и Санкт-Петербурга, медицинские комплексы,
            бизнес-центры. Полный перечень — с указанием поставленного
            оборудования по каждому проекту.
          </p>
