...
export const metadata: Metadata = {
  ...
  description:
    "Каталог инженерного оборудования ANHEL: насосные станции (водоснабжение, пожаротушение, отопление и кондиционирование, поддержание давления, специальное исполнение), блочные тепловые пункты, установки водоподготовки.",
  openGraph: {
    type: "website",
    title: "Каталог продукции · ANHEL®",
    description:
      "Семь направлений — насосные станции, тепловые пункты, водоподготовка. Заводская сборка, индивидуальная конфигурация под ТЗ.",
    url: "/products",
  },
};
      ...
      <section className="relative border-t border-[var(--color-hairline)] bg-[var(--color-primary)]">
        <div className="mx-auto w-full max-w-[1440px] px-6 pb-10 pt-28 md:px-12 md:pb-14 md:pt-32">
          ...
          <p className="mt-6 max-w-[640px] text-body text-[var(--color-secondary)]/70 md:mt-8">
            Семь направлений — пять серий насосных станций (водоснабжение,
            пожаротушение, отопление и кондиционирование, поддержание
            давления, специальное исполнение), блочные индивидуальные
            тепловые пункты и установки водоподготовки. Заводская сборка,
            серийное производство и индивидуальная конфигурация под ТЗ
            объекта.
          </p>
        </div>
      </section>

      {/* Продуктовые карточки — переиспользуем тот же компонент,
          что и на главной. Tone="page" выключает border-top и
          снижает вертикальный padding (страница уже имеет header
          выше; не нужен второй визуальный разрыв). */}
      <ProductsShowcase
        tone="page"
        monoTag="02 · ЛИНЕЙКА"
        title="Семь направлений"
        lede="Каждое направление — отдельная серия с собственной автоматикой. Кликните карточку, чтобы перейти к ТТХ, применению и опросному листу."
      />
    </>
  );
}
