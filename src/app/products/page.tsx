...
export const metadata: Metadata = {
  ...
  description:
    "Каталог инженерного оборудования ANHEL®: насосные станции водоснабжения и пожаротушения, блочные тепловые пункты, установки водоподготовки.",
  openGraph: {
    type: "website",
    title: "Каталог продукции · ANHEL®",
    description:
      "Четыре направления — насосные станции, тепловые пункты, водоподготовка. Заводская сборка, индивидуальная конфигурация под ТЗ.",
    url: "/products",
  },
};
      ...
      <section className="relative border-t border-[var(--color-hairline)] bg-[var(--color-primary)]">
        <div className="mx-auto w-full max-w-[1440px] px-6 pb-10 pt-28 md:px-12 md:pb-14 md:pt-32">
          ...
          <p className="mt-6 max-w-[640px] text-body text-[var(--color-secondary)]/70 md:mt-8">
            Четыре направления — насосные станции водоснабжения и
            пожаротушения, блочные индивидуальные тепловые пункты, установки
            водоподготовки. Заводская сборка, серийное производство и
