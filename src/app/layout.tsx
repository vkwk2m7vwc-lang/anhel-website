...
export const metadata: Metadata = {
  ...
  title: {
    ...
    // Template без « · ANHEL®» суффикса. Все локальные metadata.title
    // на product/projects-страницах уже содержат «ANHEL» в названии
    // (например «Насосные станции ANHEL для систем пожаротушения»),
    // поэтому template-суффикс давал двойной «· ANHEL® · ANHEL®» в
    // браузерной вкладке и SERP. Раньше: "%s · ANHEL®". Теперь "%s".
    template: "%s",
  },
  description:
