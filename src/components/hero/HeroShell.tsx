...
export function HeroShell({
  ...
  return (
    <section
      id="hero"
      // Variant 3 — Premium: hero flips with the theme so the
      // light canvas reads as airy and editorial. The cinematic
      // pause + Lenis smooth-scroll are the centrepiece of the
      // brand, not the dark theatre — so we let the surface
      // breathe instead of forcing a dark island.
