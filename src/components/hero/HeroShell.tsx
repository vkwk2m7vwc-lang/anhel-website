...
export function HeroShell({
  ...
  return (
    <section
      id="hero"
      // Variant 4 — iOS 26: hero flips with the theme. The Liquid
      // Glass language depends on the canvas underneath being visible
      // (that's what backdrop-blur picks up). On iOS, the system bar
      // adapts to whatever is below — same idea here.
