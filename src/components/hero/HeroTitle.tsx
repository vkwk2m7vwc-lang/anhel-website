...
export function HeroTitle() {
  ...
  if (idx === -1) {
    return (
      <h1 className="font-display text-[34px] font-semibold leading-[0.95] tracking-[-0.04em] text-[var(--color-secondary)] md:text-[44px] lg:text-[clamp(44px,min(8vw,9.5vh),180px)] lg:font-medium lg:tracking-[-0.025em]">
        {title}
      </h1>
    );
  }
  ...
  return (
    <h1 className="font-display text-[34px] leading-[0.95] tracking-[-0.04em] text-[var(--color-secondary)] md:text-[44px] lg:text-[clamp(44px,min(8vw,9.5vh),180px)] lg:tracking-[-0.025em]">
      {leading ? (
