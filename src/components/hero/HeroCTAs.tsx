  ...
  return (
    <div className="mt-8 flex w-full flex-col gap-2 md:mt-[clamp(16px,3.5vh,40px)] md:w-auto md:flex-row md:flex-wrap md:items-center md:gap-5">
      <Link
        ...
        data-cursor="hover"
        data-cta="catalog"
        className="group inline-flex w-full items-center justify-center gap-3 rounded bg-[var(--color-secondary)] px-[22px] py-[14px] text-sm font-medium text-[var(--color-primary)] md:w-auto md:justify-start"
      >
        {t("cta_primary")}
        <span
          aria-hidden="true"
      ...
      <Link
        ...
        data-cursor="hover"
        data-cta="contacts"
        className="group inline-flex w-full items-center justify-center gap-3 rounded border-[0.5px] border-[var(--color-secondary)]/40 bg-transparent px-[22px] py-[14px] text-sm font-medium text-[var(--color-secondary)] transition-colors hover:border-[var(--color-secondary)] md:w-auto md:justify-start"
      >
        {t("cta_secondary")}
        <span
          aria-hidden="true"
