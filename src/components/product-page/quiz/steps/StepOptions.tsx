 ...
 *
 * Каждая группа обёрнута в `FieldRadioGroup` с
 * `role=radiogroup|group` и `aria-labelledby` на заголовок —
 * screen reader объявляет название группы перед вариантами.
 */
