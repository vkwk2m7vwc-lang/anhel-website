...
export function MegaMenu({ onClose }: { onClose: () => void }) {
  ...
  return (
    <motion.div
      ...
      className="absolute left-1/2 top-full z-40 mt-3 w-[720px] -translate-x-1/2 rounded border border-[var(--color-secondary)]/15 bg-[var(--color-primary)]/95 p-3 shadow-2xl shadow-black/30 backdrop-blur-xl"
    >
